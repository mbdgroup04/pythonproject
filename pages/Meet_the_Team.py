...
team_members = [
    ("Leonardo V. Kietzell", "🚀 Lead Business Strategist", 
        ...
        "🏃‍♂️ He is currently training for the **Tokyo Marathon**! 🎌", "Leonardo.jpeg"),
    ...
    ("Gizela Thomas", "💻 Streamlit Developer", 
        ...
        "📰 She has been on the **front page of Yahoo News**! 🌟", "gizela.jpeg"),
    ...
    ("Nitin Jangir", "🤖 Machine Learning Engineer", 
        ...
        "🍳 Since moving to Spain, he started **eating eggs for the first time** despite being a lifelong vegetarian! 🥚", "nitin.jpeg"),
    ...
    ("Santiago Ruiz Hernández", "📌 Project Point Lead", 
        ...
        "🎾 He **loves playing tennis** and is a **natural redhead**! 🔥", "santi.jpeg"),
    ...
    ("Santiago Botero", "📈 EDA & Financial Insights", 
        ...
        "🌍 He speaks **four languages fluently**! 🗣️🌎", "santiago.jpeg")
]
