...
st.markdown(f"<p style='font-size:20px; text-align:left; '>Curious about market trends? - Try <b>TradeVision AI's</b> latest interactive prediction tool!:crystal_ball:.</p>", unsafe_allow_html=True)
